...
class onlineCalculatorTest: XCTestCase {
    ...
    private let onlineCalcBrain = OnlineCalculatorBrain()
    override func setUp() {
        super.setUp()
    }
    ...
    private func testRetreiveURLFor10DivideBy2() {
    ...
    private func testRetreiveURLFor10DivideBy2ShouldFail() {
        let url = URL(string: "https://www.calcatraz.com/calculator/api?c=10%2F2")
